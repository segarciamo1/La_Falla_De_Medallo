...
#include "ui_iniciarseccion.h"

#include "menuinicial.h"
#include "mainwindow.h"

Iniciarseccion::Iniciarseccion(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Iniciarseccion)
{
    ui->setupUi(this);
}
...
void Iniciarseccion::on_IniciarSeccionButton_clicked()
{
...
void Iniciarseccion::on_VolverButton_clicked()
{
...
void Iniciarseccion::on_RegistraseButton_clicked()
{
    hide();
    registrarse->show();
}
